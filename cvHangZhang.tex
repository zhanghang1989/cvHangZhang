...
\item 
Tech leading the Computer Vision Foundation team: \\
\- $\cdot$ Designed and led the development of the perspective-view model consolidation.\\
\- $\cdot$ Leading the development of the next generation of camera-major object detector.
\end{rSubsection}
