...
\item Lead the efforts in model consolidation of camera major model on object detection and segmentation in 2023. Leading the efforts in building a multi-task, multi-camera, multi-modality, multi-frame and multi-platform model at Perception
